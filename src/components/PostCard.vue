...
<template>
  <article class="group cursor-pointer">
    <div class="relative overflow-hidden rounded-3xl aspect-[4/3] mb-6 shadow-xl shadow-black/5 dark:shadow-white/5 border border-black/5 dark:border-white/5">
      ...
      <!-- Overlay Link -->
      <div class="absolute inset-0 bg-white/10 dark:bg-black/10 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
    ...
    <div>
      <div class="flex items-center gap-2 mb-3">
        ...
        <time class="text-[10px] uppercase tracking-widest font-medium opacity-60 dark:opacity-50">{{ post.date }}</time>
      </div>
      ...
      <p class="text-sm opacity-60 dark:opacity-100 dark:text-zinc-400 line-clamp-2 leading-relaxed">
        {{ post.excerpt }}
      </p>
    </div>
  </article>
